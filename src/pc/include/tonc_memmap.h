...
#define MEM_IO		((uintptr_t) tonc__mem_io)      //!< I/O registers
#define MEM_PAL		((uintptr_t) tonc__mem_pal)     //!< Palette. Note: no 8bit write !!
#define MEM_VRAM	((uintptr_t) tonc__mem_vram)    //!< Video RAM. Note: no 8bit write !!
#define MEM_OAM		((uintptr_t) tonc__mem_oam)     //!< Object Attribute Memory (OAM) Note: no 8bit write !!
//\}
